...
data_ip="https://raw.githubusercontent.com/huutvpn/permission/main/ipmini"
checking_sc() {
...
checking_sc
Name=$(curl -sS https://raw.githubusercontent.com/huutvpn/permission/main/ipmini | grep $ipsaya | awk '{print $2}')
# =========================================
...
wget -O /usr/bin/bot https://raw.githubusercontent.com/huutvpn/v4/main/bot.sh && chmod +x /usr/bin/bot
fi
...
4) clear ; menu-trgo ;;
5) clear ; menu-trojan ;;
6) clear ; rm -rf /root/updatefile.sh && wget https://raw.githubusercontent.com/huutvpn/v4/main/updatefile.sh && chmod +x updatefile.sh && ./updatefile.sh ;;
7) clear ; status ;;
8) clear ; restarts ;;
9) clear ; menu-backup ;;
