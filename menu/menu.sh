...
echo ""
izinsc="https://raw.githubusercontent.com/huutvpn/permission/main/ipmini"
# USERNAME
rm -f /usr/bin/user
...
11)
clear
wget -q https://raw.githubusercontent.com/huutvpn/v4/main/updatefile.sh
chmod +x update.sh
./update.sh
;;
12)
